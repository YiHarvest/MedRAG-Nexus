...
from medrag_nexus.core.ids import chunk_id, content_hash
...
from medrag_nexus.pipeline.markdown import chunk_markdown, normalize_markdown
from medrag_nexus.pipeline.parsers import ParseResult, parse_file
...
async def _parse_file_with_progress(
    ...
    heartbeat_task = asyncio.create_task(
        heartbeat(),
        name=f"medrag-nexus-parsing-progress-{task.task_id}",
    )
    try:
