...
def create_app(runtime=None, *, backend_runtime=None, services=None, features=()):
    """创建统一的后端 HTTP API、Worker 与 MCP 应用。"""
    return _create_app(runtime, backend_runtime=backend_runtime, services=services, features=features)
